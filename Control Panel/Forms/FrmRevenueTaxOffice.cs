    ...
    public partial class FrmRevenueTaxOffice : Form
    {
        ...
        public void setDBComboBox()
        {
            ...
            using (var ds = new System.Data.DataSet())
            {
                ...
                using (SqlDataAdapter ada = new SqlDataAdapter((string)"select *  from tblAgency", Logic.ConnectionString))
                {
                    ada.Fill(ds, "table");
                }
        ...
        public void setDBComboBox1(int fId)
        {
            ...
            using (var ds = new System.Data.DataSet())
            {
                ...
                using (SqlDataAdapter ada = new SqlDataAdapter((string)String.Format("select *  from tblZone where AgencyCode = '{0}' ", fId), Logic.ConnectionString))
                {
                    ada.Fill(ds, "table");
                }
        ...
        public void setDBComboBox2()
        {
            ...
            using (var ds = new System.Data.DataSet())
            {
                ...
                using (SqlDataAdapter ada = new SqlDataAdapter((string)"select *  from tblOperationModes", Logic.ConnectionString))
                {
                    ada.Fill(ds, "table");
                }
        ...
        public void setDBComboBox3(int fId)
        {
            ...
            using (var ds = new System.Data.DataSet())
            {
                ...
                using (SqlDataAdapter ada = new SqlDataAdapter((string)String.Format("select *  from tblRevenueType where AgencyCode = '{0}' ", fId), Logic.ConnectionString))
                {
                    ada.Fill(ds, "table");
                }
        ...
        private void UpdateRecord()
        {
            try
            {
                ...
                {
                    Common.setEmptyField("Agency Zone Field ", Program.ApplicationName);
                    ...
                    if (!boolIsUpdate)
                    {
                        using (SqlConnection db = new SqlConnection(Logic.ConnectionString))
                        {
                            ...
                            try
                            {
                                ...
                                //Convert.ToInt32(cboZone.SelectedValue.ToString()),
                                //new insert method here
                                string query = String.Format("INSERT INTO [tblRevenueOffice]([AgencyCode],[ZoneID],[OperationID],[OfficeName],[Address],[Telephone],[FaxNumber],[EmailAddress],[HeadOfStation]) VALUES ('{0}','{1}','{2}','{3}','{4}','{5}','{6}','{7}','{8}');SELECT @@IDENTITY", Convert.ToInt32(cboAgency.SelectedValue), Convert.ToInt32(cboZone.SelectedValue), Convert.ToInt32(cboNature.SelectedValue), txtRevOffice.Text.Trim().ToUpperInvariant(), txtAddress.Text.Trim(), txtPhone.Text.Trim(), txtFaxno.Text.Trim(), txtEmail.Text.Trim(), txtHead.Text.Trim().ToUpperInvariant());

                                int recs = Convert.ToInt32(new SqlCommand(query, db, transaction).ExecuteScalar());
                    ...
                    else
                    {
                        ...
                        using (SqlConnection db = new SqlConnection(Logic.ConnectionString))
                        {
                            ...
                            catch (SqlException e)
                            {
                                ...
                                {
                                    transaction.Rollback();
                                    Tripous.Sys.ErrorBox(e.StackTrace);
                                    return;
                                }
        ...
        private bool FillField(int fieldid)
        {
            ...
            //DataTable dts = extMethods.LoadData(String.Format("select * from ViewRevenueOffice where RevenueOfficeID ='{0}'", fieldid));
        ...
        private void FrmRevenueTaxOffice_Load(object sender, EventArgs e)
        {
